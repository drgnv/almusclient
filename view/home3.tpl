  ...
  <nav class="cd-stretchy-nav" style="display:none">
    ...
    <ul style="list-style-type: none;">
        {foreach from=$fav_pl item=$place}
         <li style="background-color:#9ACD91;margin-bottom:5px;border-radius:20px"><a style="text-decoration:none" href="./get_taxi.php?street={$place.street}&number=0&post_code=0" class="active"><span>📍{$place.street}</span></a></li>
...
{if $drivers_count > 0}
<center>Има <b>{$drivers_count}</b> {if $drivers_count == 1}шофьор{else}шофьора{/if} на линия в град {$user_info2.0.city}.</center>
{else}
...
<script>var mytextbox = document.getElementById('dirDestination');
