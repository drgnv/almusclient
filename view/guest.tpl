<html>
    <head><script src="https://code.jquery.com/jquery-3.5.1.js" integrity="sha256-QWo7LDvxbWT2tbbQ97B53yJnYU3WhH/C8ycbRAkjPDc=" crossorigin="anonymous"></script>
        <style>
...
@keyframes rotating {
 ...
 <p style="color:white;background-color:#eb4f34;padding:5px">{$error}</p>
         {/if}
           {if isset($noerror)}
            <p style="color:white;background-color:#34a1eb;padding:5px">{$noerror}</p>
